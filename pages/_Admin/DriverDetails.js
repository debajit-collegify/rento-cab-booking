...
class CabDetails extends React.Component {
    ...
    getAllCrewDetails(){
        ...
        axios.get('http://4eb3aff0.ngrok.io/api/crew').then((response) => {
            const res = response;
            console.log(res);
    ...
    addCrewDetails(){
        ...
        if(Validation.stringValidate(this.state.FormData.name) &&
            ...
            axios.post('http://4eb3aff0.ngrok.io/api/crew/create',FormData).then((response) => {
                const res = response;
                console.log(res);
    ...
    UpdateCrewDetails(){
        ...
        if(Validation.stringValidate(this.state.FormData.name) &&
            ...
            axios.put('http://4eb3aff0.ngrok.io/api/crew/crewupdate/'+this.state.FormData.id,FormData).then((response) => {
                const res = response;
                console.log(res);
    ...
    singleFetchUpdateCall(id){
        ...
        axios.get('http://4eb3aff0.ngrok.io/api/crew/getcrewbyid/'+id).then((response) => {
            const res = response;
            console.log(res);
            if(res.status === 200 && res.statusText === "OK"){
